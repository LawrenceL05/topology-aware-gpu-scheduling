...
with Ray's configured logical GPU capacity.
...
- measured inter-node bandwidth.

## 4. Choose the placement

`choose_placement()` removes incompatible nodes, enumerates feasible worker
